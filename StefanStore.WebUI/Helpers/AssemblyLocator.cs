...
namespace StefanStore.WebUI.Helpers
{
    public static class AssemblyLocator
    {
        ...
        static AssemblyLocator()
        {
            ...
            IList<string> dllFiles = Directory.GetFiles(binFolder, "*.dll", SearchOption.TopDirectoryOnly).Where(s => s.Contains("bin\\StefanStore.")).ToList();
